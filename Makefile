...
#              flags also defines DEBUG and _GLIBCXX_DEBUG   //btw I just added the o3 on the end, maybe remove
debug: CXXFLAGS += -g3 -DDEBUG -fsanitize=address -fsanitize=undefined -D_GLIBCXX_DEBUG -O3
debug:
